...
export function Ligue1Section() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      fetchFootballStandings("Ligue 1"),
      fetchFootballFixtures("LIG", "scheduled", 5, today),
      fetchFootballFixtures("LIG", "finished", 4),
    ]).then(([s, u, r]) => {
      setStandings(s);
      setUpcoming(u);
      setRecent(r);
  ...
  return (
    <>
      ...
      {activeTab === "news" && <NewsTab competition="Ligue 1" accent={ACCENT} />}
