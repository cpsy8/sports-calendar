  ...
  return (
    <>
      <div className="section-hero fade-in">
        ...
        <div className="hero-icon"><img src={competitionLogoUrl("LIG") ?? ""} alt="Ligue 1" style={{ width: "100%", height: "100%", objectFit: "contain" }} /></div>
        <div className="hero-text">
          <h2>LIGUE 1</h2>
          <p>France — 2025/26 Season</p>
        </div>
        {matchday !== null && (
          <div className="hero-badge" style={{ background: "#091c3e20", color: ACCENT }}>
            Matchday {matchday}
          </div>
        )}
      </div>
      ...
      {activeTab === "fixtures" && (
        <FixturesTabPanel competitionShort="LIG" leagueCode={LEAGUE} accent={ACCENT} />
      )}
      ...
      {activeTab === "teams" && (
        <TeamsTab competitionShort="LIG" leagueCode={LEAGUE} accent={ACCENT} />
      )}
    </>
  );
}
