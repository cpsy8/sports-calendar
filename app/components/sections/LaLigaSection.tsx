...
export function LaLigaSection() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      fetchFootballStandings("La Liga"),
      fetchFootballFixtures("LAL", "scheduled", 5, today),
      fetchFootballFixtures("LAL", "finished", 4),
    ]).then(([s, u, r]) => {
      setStandings(s);
      setUpcoming(u);
      setRecent(r);
  ...
  return (
    <>
      ...
      {activeTab === "news" && <NewsTab competition="La Liga" accent={ACCENT} />}
